...
def test_available_models():
    ...
    if "models" in result:
        ...
        if "availableModels" in models:
            print(f"   ✓ availableModels present with {len(models['availableModels'])} models:")
    ...
    assert "availableModels" in result["models"], "models should contain availableModels"
    assert len(result["models"]["availableModels"]) > 0, "availableModels should not be empty"
